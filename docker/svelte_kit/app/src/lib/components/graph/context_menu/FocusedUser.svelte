<script lang="ts">
	...
	import NoContext from '$lib/components/graph/context_menu/user_view/NoContext.svelte';
	import NoContextAdmin from '$lib/components/graph/context_menu/admin_view/NoContextAdmin.svelte';
